...
/// Preferences related
///
const String _storageKey = "Vc_QltpDt_";
...
class GlobalTranslations {
  ...
  ///
  ///
  Iterable<Locale> supportedLocales() => VcConst.listLanguages.map<Locale>((lang) => new Locale(lang, ''));
  ...
  Future<Null> setNewLanguage([String newLanguage, bool saveInPrefs = false]) async {
    ...
    // Set the locale
    if (language == ""){
      language = VcConst.listLanguages[0];
    }
